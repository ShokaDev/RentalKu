        ...
        <div class="max-w-7xl mx-auto px-6 h-full flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                ...
                <?php else: ?>
                    <!-- Logged In - User Menu -->
                    <!-- User Menu -->
                    <div class="hidden md:block relative" id="userDropdown">
                        <button id="userDropdownBtn" class="flex items-center gap-3 px-4 py-2 rounded-full hover:bg-gray-100 transition-all">
                        ...
                        <!-- Dropdown Menu -->
                        <div id="userMenu" class="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-xl border border-gray-100 py-2 hidden">
